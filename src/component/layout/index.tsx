...
import { selectedPatient } from '../../actions';
...
function Layout(props: any) {
	...
	const list = (anchor: string) => (
		...
		>
			<List>
				{['Patient List', 'Add Patient'].map((text, index) => (
					<ListItem
						button
						key={text}
						onClick={
							text === 'Patient List' ? navigateHome : navigateAddPatient
						}
					>
						<ListItemIcon>
							{text === 'Patient List' ? <ListIcon /> : <Add />}
						</ListItemIcon>
	...
	const renderMobileMenu = (
		...
		>
			<MenuItem onClick={navigateAddPatient}>
...
export default connect(null, { selectedPatient })(Layout);
